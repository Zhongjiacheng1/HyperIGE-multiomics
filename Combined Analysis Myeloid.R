...
# rm(list = ls())
# setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/Preprocessing/")
# library(Seurat)
# library(dplyr)
# 
# load("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/Seurat/SeuratPBMC/ReannotationAndElimination/SeuratPBMC_Annotated_Myeloid.Rdata")
# 
...
# rm(list = ls())
# setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/Annotation/")
# library(Seurat)
# library(dplyr)
# library(ggplot2)
# library(emojifont)
...
# 
# load("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/Preprocessing/Myeloid_reclustering.Rdata")
# 
...
# # ATAC
# 
# M.ATAC <- suppressMessages(loadArchRProject(path = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/ATAC/AnnotatedATAC/Myeloid/"))
# 
...
# 
# saveArchRProject(ArchRProj = M.ATAC, outputDirectory = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/Annotation/ATAC/", load = F, overwrite = T)
...
# suppressMessages(library(ArchR))
# 
# M.ATAC <- suppressMessages(loadArchRProject(path = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/Annotation/ATAC/"))
...
rm(list = ls())
setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/")
...
M.ATAC <- suppressMessages(loadArchRProject(path = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/Annotation/ATAC/"))
load(file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/Annotation/AnnotatedMyeloid.Rdata")
load(file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/Annotation/Differential_Test_Results.Rdata")
load(file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/Annotation/GenomicInformation.Rdata")
...
for (CellType in names(table(M.ATAC$predictedGroup_Co))) {
  svg(filename = paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/EnrichedMotif/Up-", CellType, ".svg", sep = ""), width = 6, height = 7)
  print(PlotEnrichedTFMotif(DET[[CellType]]$motifsUp, dotsize = 3, labelsize = 4, repulsion = 25, DeviationZ = DeviationZ, UpIn = "Patient"))
  dev.off()
  
  svg(filename = paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/EnrichedMotif/Down-", CellType, ".svg", sep = ""), width = 6, height = 7)
...
svg(filename = paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/EnrichedMotif/", "DownUpset.svg", sep = ""), width = 5, height = 3)
UpSet(make_comb_mat(AllSigTFMotif[grep(names(AllSigTFMotif), pattern = "Down")]), 
      comb_col = "#C0E2FC", bg_col = "#F0F0FF", bg_pt_col = "#1C97F4")
dev.off()

svg(filename = paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/EnrichedMotif/", "UUppset.svg", sep = ""), width = 5, height = 3)
...
# 
# Output_to_bed_files(Fragment_list_cl = Fragment_By_CellType, folder = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/FragmentsByCellTypes/")
# 
...
#   print(i)
#   outdir <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/BAM/"
...
# }
# 
# bedpetobam <- c(paste("cd", "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/FragmentsByCellTypes/"), bedpetobam)
# 
...
# for(i in names(Fragment_By_CellType)){
#   print(i)
#   outdir <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/sBAM/"
...
# }
# 
# samtools_sort <- c(paste("cd", "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/BAM/"), samtools_sort)
# 
...
# }
# 
# samtools_index <- c(paste("cd", "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/sBAM/"), samtools_index)
# 
# write.table(c(bedpetobam, samtools_sort, samtools_index), file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/fragments2bams.txt", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
# export.bed(getPeakSet(M.ATAC), con = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/ATACorrect/AllPeaks.bed")
# 
# ATACorrect <- c()
# for(i in names(Fragment_By_CellType)){
#   Input <- paste(i, "_fragments_cl_bamGR_pe_s.bam", sep = "")
#   AllPeaks <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/ATACorrect/AllPeaks.bed"
...
#   OutPut <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/ATACorrect/"
# 
...
# }
# 
# ATACorrect <- c(paste("cd", "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/sBAM/"), ATACorrect)
# 
# write.table(ATACorrect, file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/ATACorrectScript.txt", quote = FALSE, row.names = FALSE, col.names = FALSE)

############################### ScoreBigwig ####################################
# ScoreBigwig <- c()
# for(i in names(Fragment_By_CellType)){
#   Input <- paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/ATACorrect/", i, "/", i, "_fragments_cl_bamGR_pe_s_corrected.bw", sep = "")
#   AllPeaks <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/ATACorrect/AllPeaks.bed"
#   OutPut <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/ScoreBigwig/"
...
# }
# 
# ScoreBigwig <- c(paste("cd", "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/ScoreBigwig/"), ScoreBigwig)
# 
# write.table(ScoreBigwig, file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/ScoreBigwigScript.txt", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
#   Genome <- "/mnt/TRAINING/Zhongjiacheng/ReferenceGenome/hg38.fa"
#   AllPeaks <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/ATACorrect/AllPeaks.bed"
#   BigwigDir <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/ScoreBigwig/"
...
# }
# 
# BINDetect <- c(paste("cd", "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/DiffTFOccupancy/"), BINDetect)
# 
# write.table(BINDetect, file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/BINDetectScript.txt", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
for (CellType in ValidTFB) {
  tmp <- readxl::read_xlsx(paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Myeloid/DownStream/TOBIAS/DiffTFOccupancy/", 
