...
# rm(list = ls())
# 
# setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/ImmuneRepertoire/")
# 
...
#   contig_tab <-  contig_tab[!rownames(contig_tab) %in% eliminate,]
# 
#   filename <- paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/ImmuneRepertoire/ProcessedData/", type, "/", export, sep = "")
...
# PreprocessVDJ(contig = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/PBMC-HyperIGE-BCR/filtered_contig_annotations.csv", type = "BCR", export = "Patient.csv")
# 
...
# PreprocessVDJ(contig = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/PBMC-HyperIGE-TCR/filtered_contig_annotations.csv", type = "TCR", export = "Patient.csv")

#######################scRNAseq processing for integration######################
# rm(list = ls())
# setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/Seurat/QualityControl/")
# 
# library(Seurat)
...
# library(ggplot2)
# 
# SeuratPatientPBMC <- CreateSeuratObject(counts =  Read10X(data.dir = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/PBMC-HyperIGE-scRNA/filtered_feature_bc_matrix/"), min.cells = 3)
...
# 
# SeuratPatientBALF <- CreateSeuratObject(counts = Read10X(data.dir = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/BALF-HyperIGE-scRNA/filtered_feature_bc_matrix/"), min.cells = 3)
...
##########################MergeDatasets-PBMC####################################
# rm(list = ls())
# setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/Seurat/SeuratPBMC/MergeDatasets/")
# 
# library(ggplot2)
# library(Seurat)
# library(dplyr)
# 
# load("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/Seurat/QualityControl/PreprocessedPBMCSamples.Rdata")
# load("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/Seurat/cycle.rda")
# 
# pc.use <- 30
# 
...
# rm(list = ls())
# setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/Seurat/SeuratPBMC/ReannotationAndElimination/")
# 
# library(ggplot2)
# library(Seurat)
# library(dplyr)
...
# 
# load("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/Seurat/SeuratPBMC/MergeDatasets/SeuratPBMCIntegrated.Rdata")
# 
...
# 
# save(TNK.RNA, file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/Seurat/SeuratPBMC/ReannotationAndElimination/SeuratPBMC_Annotated_TNK.Rdata")
# save(B.RNA, file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/Seurat/SeuratPBMC/ReannotationAndElimination/SeuratPBMC_Annotated_B.Rdata")
# save(Myeloid.RNA, file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/Seurat/SeuratPBMC/ReannotationAndElimination/SeuratPBMC_Annotated_Myeloid.Rdata")

################################## Cell chat ###################################
rm(list = ls())
setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/Seurat/SeuratPBMC/CellChat/")
...
# rm(list = ls())
# setwd(dir = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/ATAC/")
# 
# suppressMessages(library(ArchR))
...
#   inputFiles = c("/mnt/TRAINING/Zhongjiacheng/HyperIGE/PBMC-HyperIGE-scATAC/fragments.tsv.gz",
...
#   LSIMethod = 1, outDir = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/ATAC/Doublet/"
# )
# 
...
# 
# saveArchRProject(ArchRProj = projectPBMC, outputDirectory = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/ATAC/PreprocessedATAC/", load = F, overwrite = T)
# 
# ##
# 
# rm(list = ls())
# setwd(dir = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/ATAC/")
# 
# projectPBMC <- suppressMessages(loadArchRProject(path = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/ATAC/PreprocessedATAC/"))
# 
# projectPBMC <- addUMAP(
#   ArchRProj = projectPBMC,
...
# dev.off()
# 
# saveArchRProject(ArchRProj = projectPBMC, outputDirectory = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/ATAC/BatchCorrectedATAC/", load = F, overwrite = T)
...
# addArchRThreads(threads = 16)
# 
# setwd(dir = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/Main cell types/")
# 
# load("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/Seurat/SeuratPBMC/ReannotationAndElimination/SeuratPBMC_Annotated_MainCellType.Rdata")
# projectPBMC <- suppressMessages(loadArchRProject(path = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/ATAC/BatchCorrectedATAC/"))
# 
...
# 
# saveArchRProject(ArchRProj = subsetCells(projectPBMC, TNK), outputDirectory = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/ATAC/AnnotatedATAC/TNK/", load = F, overwrite = T)
# saveArchRProject(ArchRProj = subsetCells(projectPBMC, B), outputDirectory = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/ATAC/AnnotatedATAC/B/", load = F, overwrite = T)
# saveArchRProject(ArchRProj = subsetCells(projectPBMC, Myeloid), outputDirectory = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/ATAC/AnnotatedATAC/Myeloid/", load = F, overwrite = T)