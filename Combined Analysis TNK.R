...
# rm(list = ls())
# setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/Preprocessing/")
# library(Seurat)
# library(dplyr)
# 
# load("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/Seurat/SeuratPBMC/ReannotationAndElimination/SeuratPBMC_Annotated_TNK.Rdata")
# 
...
# rm(list = ls())
# setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/Annotation/")
# library(Seurat)
# library(dplyr)
# library(ggplot2)
# library(emojifont)
...
# 
# load("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/Preprocessing/TNK_reclustering.Rdata")
# 
...
# 
# Cluster2Unicode <- readxl::read_xlsx(path = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/Dec2UnicodeSymbol.xlsx")
...
# # ATAC
# 
# TNK.ATAC <- suppressMessages(loadArchRProject(path = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/ATAC/AnnotatedATAC/TNK/"))
# 
...
# 
# saveArchRProject(ArchRProj = TNK.ATAC, outputDirectory = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/Annotation/ATAC/", load = F, overwrite = T)
...
# suppressMessages(library(ArchR))
# 
# TNK.ATAC <- suppressMessages(loadArchRProject(path = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/Annotation/ATAC/"))
...
rm(list = ls())
setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/")
...
TCR10Xp <- immunarch::repLoad(.path = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/ImmuneRepertoire/ProcessedData/TCR/")

TNK.ATAC <- suppressMessages(loadArchRProject(path = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/Annotation/ATAC/"))
load(file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/Annotation/AnnotatedTNK.Rdata")
load(file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/Annotation/Differential_Test_Results.Rdata")
load(file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/Annotation/GenomicInformation.Rdata")
...
Trajectory(Immune[,Immune$orig.ident == "PatientPBMC" & Immune$IntermediateGranularity %in% c("CD4", "Naive CD4")], rootcluster = "Naive CD4", 
           directory = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/RNATrajectory/", palette = TcellsPalette,
...
for (CellType in names(table(TNK.ATAC$predictedGroup_Co))) {
  svg(filename = paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/EnrichedMotif/Up-", CellType, ".svg", sep = ""), width = 6, height = 7)
  print(PlotEnrichedTFMotif(DET[[CellType]]$motifsUp, dotsize = 3, labelsize = 4, repulsion = 25, DeviationZ = DeviationZ, UpIn = "Patient"))
  dev.off()
  
  svg(filename = paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/EnrichedMotif/Down-", CellType, ".svg", sep = ""), width = 6, height = 7)
...
svg(filename = paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/EnrichedMotif/", "DownUpset.svg", sep = ""), width = 5, height = 3)
UpSet(make_comb_mat(AllSigTFMotif[grep(names(AllSigTFMotif), pattern = "Down")]), 
      comb_col = "#C0E2FC", bg_col = "#F0F0FF", bg_pt_col = "#1C97F4")
dev.off()

svg(filename = paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/EnrichedMotif/", "UUppset.svg", sep = ""), width = 5, height = 3)
...
# }
# 
# save(FilteredPatientP2G, file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/FilteredPatientP2G.Rdata")

load(file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/FilteredPatientP2G.Rdata")
...
# 
# Output_to_bed_files(Fragment_list_cl = Fragment_By_CellType, folder = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/FragmentsByCellTypes/")
# 
...
#   print(i)
#   outdir <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/BAM/"
...
# }
# 
# bedpetobam <- c(paste("cd", "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/FragmentsByCellTypes/"), bedpetobam)
# 
...
# for(i in names(Fragment_By_CellType)){
#   print(i)
#   outdir <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/sBAM/"
...
# }
# 
# samtools_sort <- c(paste("cd", "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/BAM/"), samtools_sort)
# 
...
# }
# 
# samtools_index <- c(paste("cd", "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/sBAM/"), samtools_index)
# 
# write.table(c(bedpetobam, samtools_sort, samtools_index), file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/fragments2bams.txt", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
# export.bed(getPeakSet(TNK.ATAC), con = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/ATACorrect/AllPeaks.bed")
# 
# ATACorrect <- c()
# for(i in names(Fragment_By_CellType)){
#   Input <- paste(i, "_fragments_cl_bamGR_pe_s.bam", sep = "")
#   AllPeaks <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/ATACorrect/AllPeaks.bed"
...
#   OutPut <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/ATACorrect/"
# 
...
# }
# 
# ATACorrect <- c(paste("cd", "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/sBAM/"), ATACorrect)
# 
# write.table(ATACorrect, file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/ATACorrectScript.txt", quote = FALSE, row.names = FALSE, col.names = FALSE)

############################### ScoreBigwig ####################################
# ScoreBigwig <- c()
# for(i in names(Fragment_By_CellType)){
#   Input <- paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/ATACorrect/", i, "/", i, "_fragments_cl_bamGR_pe_s_corrected.bw", sep = "")
#   AllPeaks <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/ATACorrect/AllPeaks.bed"
#   OutPut <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/ScoreBigwig/"
...
# }
# 
# ScoreBigwig <- c(paste("cd", "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/ScoreBigwig/"), ScoreBigwig)
# 
# write.table(ScoreBigwig, file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/ScoreBigwigScript.txt", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
#   Genome <- "/mnt/TRAINING/Zhongjiacheng/ReferenceGenome/hg38.fa"
#   AllPeaks <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/ATACorrect/AllPeaks.bed"
#   BigwigDir <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/ScoreBigwig/"
...
# }
# 
# BINDetect <- c(paste("cd", "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/DiffTFOccupancy/"), BINDetect)
# 
# write.table(BINDetect, file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/BINDetectScript.txt", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
for (CellType in ValidTFB) {
  tmp <- readxl::read_xlsx(paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/DiffTFOccupancy/", 
...
svg(filename = paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/Volcano/", "UUppset.svg", sep = ""), width = 5, height = 3)
UpSet(make_comb_mat(AllMotifUpList), comb_col = "#FCC8C4", bg_col = "#FFF1F3", bg_pt_col = "#F52B1B")
dev.off()

svg(filename = paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/Volcano/", "DownUpset.svg", sep = ""), width = 5, height = 3)
...
#   Check_normalized_Signal(file = paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/ATACorrect/",
#                                        i, "/", i, "_fragments_cl_bamGR_pe_s_corrected.bw", sep = ""),
#                           savefile = paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/NormalizedSignal/", i, sep = ""))
# }
# 
# library(motifmatchr)
...
#   NormalizedSignal <- readRDS(paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/TOBIAS/NormalizedSignal/", Fragment_By_CellType, sep = ""))
...
for (CellType in names(which(table(Patient.TNK.ATAC$predictedGroup_Co) > 100))) {
  ...
  if (nrow(Origin) == nrow(Origin[is.na(Origin$ExpStatusTarget),])) {
    ...
    if (length(which(Origin$SourceNodes == Origin$TargetNode)) == length(Origin$SourceNodes)) {
      ...
      svg(filename = paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/Cytoscape/", CellType, "legend.svg", sep = ""), height = 3, width = 5)
      plot.new()
      draw(lgd, x = unit(6, "cm"), y = unit(5, "cm"), just = c("left", "bottom"))
      dev.off()
      
      write.csv(Cytoscape[[CellType]], file = paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/Cytoscape/", CellType, "Cytoscape.csv", sep = ""), row.names = F, quote = F)
    }
  }
}
...
ExtractSubNetWork(CellType = "CD4", CytoscapeNetWork = Cytoscape,
                  ...
                  OutPutDir = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/Cytoscape/")
...
# Peak2Gene Legend
svg(filename = paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/BroswerTrack/", "P2Glegend.svg", sep = ""), height = 5, width = 5)
plot.new()
...
TF <- "KLF13"
CellType <- "CD4"
svg(filename = paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/BroswerTrack/", Gene, TF, CellType, ".svg", sep = ""), width = 5.5, height = 6)
...
for (TF in names(Footprints)) {
  OutPutDir <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/TNK/DownStream/FootPrint/"
