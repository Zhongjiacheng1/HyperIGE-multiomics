########################## MergeDatasets-BALF ##################################
# rm(list = ls())
# setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/Seurat/SeuratBALF/MergeDatasets/")
# 
# library(ggplot2)
# library(Seurat)
# library(dplyr)
# 
# load("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/Seurat/QualityControl/PreprocessedBALFSamples.Rdata")
...
# rm(list = ls())
# setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/Seurat/SeuratBALF/CellTypeIdentification/")
# 
# library(ggplot2)
# library(Seurat)
# library(dplyr)
# 
# load("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/Seurat/SeuratBALF/MergeDatasets/SeuratBALFIntegrated.Rdata")
# 
...
# rm(list = ls())
# setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/BALF/BALFOnly/MainCellTypes")
# 
# library(ggplot2)
# library(Seurat)
# library(dplyr)
...
# 
# load("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/Seurat/SeuratBALF/CellTypeIdentification/SeuratBALFIntegratedandMarkers.Rdata")
# 
...
# rm(list = ls())
# setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/BALF/BALFOnly/Myeloid/")
# 
# library(ggplot2)
# library(Seurat)
# library(dplyr)
# 
# load(file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/BALF/BALFOnly/MainCellTypes/Myeloid.BALF.Rdata")
# 
# pc.use <- 30
# 
...
rm(list = ls())
setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/BALF/BALFOnly/Myeloid/Analysis/")
...
load("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/BALF/BALFOnly/Myeloid/Myeloid_BALF_reclustering.Rdata")
...
# rm(list = ls())
# setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/BALF/BALFOnly/TNK/")
# 
# library(Seurat)
# library(dplyr)
# library(ggplot2)
...
# source("/mnt/TRAINING/Zhongjiacheng/Customized Codes.R")
# 
# load(file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/BALF/BALFOnly/MainCellTypes/TNK.BALF.Rdata")
# 
...
rm(list = ls())
setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/BALF/BALFOnly/TNK/Analysis/")
...
load("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/BALF/BALFOnly/TNK/TNK_BALF_reclustering.Rdata")
