...
# rm(list = ls())
# setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/Preprocessing/")
# library(Seurat)
# library(dplyr)
# 
# load("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/Seurat/SeuratPBMC/ReannotationAndElimination/SeuratPBMC_Annotated_B.Rdata")
# 
...
# rm(list = ls())
# setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/Annotation/")
# library(Seurat)
# library(dplyr)
# library(ggplot2)
# library(emojifont)
...
# 
# load("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/Preprocessing/B_reclustering.Rdata")
# 
...
# # ATAC
# 
# B.ATAC <- suppressMessages(loadArchRProject(path = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/ATAC/AnnotatedATAC/B/"))
# 
...
# 
# saveArchRProject(ArchRProj = B.ATAC, outputDirectory = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/Annotation/ATAC/", load = F, overwrite = T)
...
# suppressMessages(library(ArchR))
# 
# B.ATAC <- suppressMessages(loadArchRProject(path = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/Annotation/ATAC/"))
...
rm(list = ls())
setwd("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/")
...
BCR10Xp <- immunarch::repLoad(.path = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/ImmuneRepertoire/ProcessedData/BCR/")

B.ATAC <- suppressMessages(loadArchRProject(path = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/Annotation/ATAC/"))
load(file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/Annotation/AnnotatedB.Rdata")
load(file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/Annotation/Differential_Test_Results.Rdata")
load(file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/Annotation/GenomicInformation.Rdata")
...
for (CellType in names(table(B.ATAC$predictedGroup_Co))) {
  svg(filename = paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/EnrichedMotif/Up-", CellType, ".svg", sep = ""), width = 6, height = 7)
  print(PlotEnrichedTFMotif(DET[[CellType]]$motifsUp, dotsize = 3, labelsize = 4, repulsion = 25, DeviationZ = DeviationZ, UpIn = "Patient"))
  dev.off()
  
  svg(filename = paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/EnrichedMotif/Down-", CellType, ".svg", sep = ""), width = 6, height = 7)
...
# 
# Output_to_bed_files(Fragment_list_cl = Fragment_By_CellType, folder = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/FragmentsByCellTypes/")
# 
...
#   print(i)
#   outdir <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/BAM/"
...
# }
# 
# bedpetobam <- c(paste("cd", "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/FragmentsByCellTypes/"), bedpetobam)
# 
...
# for(i in names(Fragment_By_CellType)){
#   print(i)
#   outdir <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/sBAM/"
...
# }
# 
# samtools_sort <- c(paste("cd", "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/BAM/"), samtools_sort)
# 
...
# }
# 
# samtools_index <- c(paste("cd", "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/sBAM/"), samtools_index)
# 
# write.table(c(bedpetobam, samtools_sort, samtools_index), file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/fragments2bams.txt", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
# export.bed(getPeakSet(B.ATAC), con = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/ATACorrect/AllPeaks.bed")
# 
# ATACorrect <- c()
# for(i in names(Fragment_By_CellType)){
#   Input <- paste(i, "_fragments_cl_bamGR_pe_s.bam", sep = "")
#   AllPeaks <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/ATACorrect/AllPeaks.bed"
...
#   OutPut <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/ATACorrect/"
# 
...
# }
# 
# ATACorrect <- c(paste("cd", "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/sBAM/"), ATACorrect)
# 
# write.table(ATACorrect, file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/ATACorrectScript.txt", quote = FALSE, row.names = FALSE, col.names = FALSE)

############################### ScoreBigwig ####################################
# ScoreBigwig <- c()
# for(i in names(Fragment_By_CellType)){
#   Input <- paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/ATACorrect/", i, "/", i, "_fragments_cl_bamGR_pe_s_corrected.bw", sep = "")
#   AllPeaks <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/ATACorrect/AllPeaks.bed"
#   OutPut <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/ScoreBigwig/"
...
# }
# 
# ScoreBigwig <- c(paste("cd", "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/ScoreBigwig/"), ScoreBigwig)
# 
# write.table(ScoreBigwig, file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/ScoreBigwigScript.txt", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
#   Genome <- "/mnt/TRAINING/Zhongjiacheng/ReferenceGenome/hg38.fa"
#   AllPeaks <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/ATACorrect/AllPeaks.bed"
#   BigwigDir <- "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/ScoreBigwig/"
...
# }
# 
# BINDetect <- c(paste("cd", "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/DiffTFOccupancy/"), BINDetect)
# 
# write.table(BINDetect, file = "/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/BINDetectScript.txt", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
for (CellType in ValidTFB) {
  tmp <- readxl::read_xlsx(paste("/mnt/TRAINING/Zhongjiacheng/HyperIGE/Results/CombinedAnalyses/PBMC/B/DownStream/TOBIAS/DiffTFOccupancy/", 
